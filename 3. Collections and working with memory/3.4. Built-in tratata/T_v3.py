...
def truth_tables():
    ...
    if '(' in list(tokens):
        brackets = tokens[tokens.index('('):tokens.index(')') + 1]
        ...
        # copy_tokens = tokens[:tokens.index('(')] + brackets + tokens[tokens.index(')') + 1:]
